...
n64dd_FileEntry(0x00CE68C0, DDHOOK_OVL_BOSS_FD, 0x7330, 1)
n64dd_FileEntry(0x00D04A60, DDHOOK_OVL_BOSS_FD2, 0x3D30, 1)
n64dd_FileEntry(0x00C81B20, DDHOOK_OVL_BG_HIDAN_CURTAIN, 0xAA0, 1)

n64dd_FileEntry(0x026B3000, EZLJ_SCENE3E, EZLJ_SCENE3E.size, 0)
n64dd_FileEntry(0x02710000, EZLJ_SCENE3E_MAP13, EZLJ_SCENE3E_MAP13.size, 0)

n64dd_FileEntry(0x00BA1300, ovl_opening_init - 0xC8, 0x160, 0)
...
n64dd_FileEntry(0x00CE6980, DDHOOK_OVL_BOSS_FD, 0x7330, 1)
n64dd_FileEntry(0x00D04B20, DDHOOK_OVL_BOSS_FD2, 0x3D30, 1)
n64dd_FileEntry(0x00C81B00, DDHOOK_OVL_BG_HIDAN_CURTAIN, 0xAA0, 1)
...
n64dd_FileEntry(0x00BA1190, ovl_opening_init - 0xC8, 0x160, 0)
