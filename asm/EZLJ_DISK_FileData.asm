...
n64dd_FileEntry(0x0122C000, DDHOOK_OBJECT_MIZU_OBJECTS, 0xB320)
n64dd_FileEntry(0x012A2000, DDHOOK_OBJECT_ICE_OBJECTS, 0x8D50)
n64dd_FileEntry(0x013FD000, DDHOOK_OBJECT_SPOT02_OBJECTS, 0x16620)

n64dd_FileEntry(0x01A3C000, DDHOOK_PARAMETER_STATIC, 0x3B00)
n64dd_FileEntry(0x01389000, DDHOOK_OBJECT_SD, 0xC6E0)
