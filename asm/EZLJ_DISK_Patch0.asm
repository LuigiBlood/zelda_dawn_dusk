...
dw (0x3C050000 + ((DDHOOK_ICON_ITEM_FIELD_STATIC + (((DDHOOK_ICON_ITEM_FIELD_STATIC + EZLJ_ICON_ITEM_FIELD_STATIC.size) & 0x8000) << 1)) >> 16)), (0x3C0F0000 + ((DDHOOK_ICON_ITEM_FIELD_STATIC + EZLJ_ICON_ITEM_FIELD_STATIC.size) >> 16))
dw (0x25EF0000 + ((DDHOOK_ICON_ITEM_FIELD_STATIC + EZLJ_ICON_ITEM_FIELD_STATIC.size) & 0xFFFF)), (0x24A52000 + (DDHOOK_ICON_ITEM_FIELD_STATIC & 0xFFFF))
//dw 0x3C050085, 0x3C0F0086, 0x25EFD930, 0x24A52000

//icon_item_nes_static
dw (DDHOOK_OVL_KALEIDO_SCOPE + 0x14520), 0x10
dw (0x3C050000 + ((DDHOOK_ICON_ITEM_NES_STATIC + (((DDHOOK_ICON_ITEM_NES_STATIC + EZLJ_ICON_ITEM_NES_STATIC.size) & 0x8000) << 1)) >> 16)), (0x24A50000 + (DDHOOK_ICON_ITEM_NES_STATIC & 0xFFFF))
dw 0x15E0000B, (0x3C0E0000 + ((DDHOOK_ICON_ITEM_NES_STATIC + EZLJ_ICON_ITEM_NES_STATIC.size) >> 16))
//dw 0x3C050087, 0x24A52000, 0x15E0000B, 0x3C0E0088

dw (DDHOOK_OVL_KALEIDO_SCOPE + 0x14558), 0x4
dw (0x25CE0000 + ((DDHOOK_ICON_ITEM_NES_STATIC + EZLJ_ICON_ITEM_NES_STATIC.size) & 0xFFFF))
//dw 0x25CEFC80
